...
The stimulus of interest comes on screen 1 s after trial onset. To start our trial at zero, and not 1 s, we take each time bin and subtract it from the first. Next, we truncate the trial to 4200 ms--this seems to be when conditions begin to diverge for our data after visual inspection. 
```{r, echo=FALSE}
